...
**Fee savings:** Every planned entry is a maker order to reduce fee drag versus taker execution. Exits stay MARKET for instant execution.
...
| Rotations/day | 2-4 | 0 |
| AF fee per entry | Market-dependent taker fee | Market-dependent maker fee |
