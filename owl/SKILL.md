...
- `ratePerPeriod` is per 8h funding as a decimal fraction
- annualized percentage is `ratePerPeriod * 3 * 365 * 100`
- example: `0.0001` = `0.01%` per 8h = `0.03%` per day = `10.95%` annualized
