...
MAMBA detects range-bound conditions on Aftermath Finance (tight Bollinger Bands, low ATR, RSI at extremes, declining volume) and enters at support/resistance boundaries. DSL High Water Mode trails the position — capturing both the range bounce and any breakout that escapes the range.
