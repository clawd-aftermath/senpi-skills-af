...
```json
{
  ...
  "entry": {
    ...
    "bannedPrefixes": ["xyz:"],
    "_note_banned": "XYZ equities (GOLD, PAXG, NVDA, etc.) accounted for -$80+ in v1.0 losses. SM data is weak for equities on Aftermath Finance. Ban until proven otherwise."
  },
