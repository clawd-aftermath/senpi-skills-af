...
AI-powered trading bot for Aftermath via [Senpi](https://senpi.ai), running on [OpenClaw](https://openclaw.ai).
...
DSL v5.2 (3min)  →  Trailing stop loss with 7 tiers
                     ...
                     Native SL/TP on Aftermath Finance via edit_position
