...
Guide users through their first complete trade on Aftermath Finance via Senpi. This skill teaches the core loop: **discover top traders** → **create a strategy** that mirrors a chosen trader → **monitor** → **close strategy**.
...
> 1️⃣ **Discover** — Find top-performing traders on Aftermath Finance  
