...
The scanner's `leverage` recommendation is conservative. Always check `max-leverage.json` for actual maximums from the Aftermath API `meta` endpoint. See `/data/workspace/recipes/max-leverage.md`.
